...
# TODO change coordinates to [ux, uȳ, uz̄, θx, θȳ, θz̄, ϕx] 
# TODO track difference between static_fem and pybeamnlfea until fixed 
...
beam.add_nodal_load(nelems, [-1, 0, 0, 0, 0, 0, 0], NodalLoad) # load at end node 
